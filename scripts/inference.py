...
from doctr.models import crnn_vgg16_bn_hinglish, db_resnet50
...
def get_result(args):
    ...
    if(isinstance(args.det_model, str)):
    ...
    #Recognition model
    reco_model = crnn_vgg16_bn_hinglish(pretrained=False, vocab=VOCABS[args.vocab])
